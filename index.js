...
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 3: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀  
 ...
 Example, if getArtistByIndex  with the ais invokedrtists array and the number 0, it will return `the artist at index 0 is Amedeo Modigliani` */
...
function lotsOfArt(artists){
  let numberOfPaintings = []
  for (let i = 0; i < artists.length; i++){
    if (artists[i].paintings >= 100){
      numberOfPaintings.push(artists[i].name);
    }
  } 
